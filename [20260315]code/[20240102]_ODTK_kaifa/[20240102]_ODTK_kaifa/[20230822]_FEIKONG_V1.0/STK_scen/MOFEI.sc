...
BEGIN Scenario
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 24 Jul 2023 04:00:00.000000000
                    Stop		 25 Jul 2023 04:00:00.000000000
                END Interval
    ...
    <SCOPE Class = "RadarClutterExtension">
        ...
        BEGIN Graphics
            ...
            BEGIN DisplayFlags
                ...
                ShowPlanetCBIPos		 Off
                ShowPlanetCBILabel		 Off
            ...
            BEGIN MapData
                ...
                BEGIN Map
                    ...
                    BEGIN RecordMovie
                        OutputFormat		 WMV
                        Directory		 C:\Users\chenz\Documents\STK 11 (x64)
                        BaseName		 Frame
                        Digits		 4
                        Frame		 0
                        LastAnimTime		 0
...
# order: kind:domain:country:catagory:subCatagory:specific:xtra ( -1 = * )
    ...
    BEGIN References
        ...
        Instance Planet/Sun
            Planet/Sun		
        END Instance
        Instance Satellite/DROA
            Satellite/DROA		
        END Instance
        Instance Satellite/DROB
            Satellite/DROB		
        END Instance
        Instance Satellite/DROL
            Satellite/DROL		
        END Instance
    END References
