...
if plot_IO == 1
    ...
    % 输出
    product.Outputs.Style = 'D:\Program Files\AGI\ODTK 7\ODTK\AppData\Styles\Static\Residual Ratios.gph';
    product.Outputs.Display = 1;
    product.Outputs.Export.Enabled = 0;
    ...
    % 输出
    product_posUncert.Outputs.Style = 'D:\Program Files\AGI\ODTK 7\ODTK\AppData\Styles\Static\Position Uncertainty.gph';
    ...
    % 输出
    product_posUncert.Outputs.Style = 'D:\Program Files\AGI\ODTK 7\ODTK\AppData\Styles\Static\Velocity Uncertainty.gph';
    product_posUncert.Outputs.Display = 1;
    product_posUncert.Outputs.Export.Enabled = 0;
